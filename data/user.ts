...
import { MailinatorInbox, mailboxAddress } from './mailinator-inboxes';
...
// The email is a FIXED Mailinator address (inbox INVITE_SIGNUP) — not unique per
...
export const fakeInvitedUser = (): InvitedUser =>
  new InvitedUser(
    mailboxAddress(MailinatorInbox.INVITE_SIGNUP),
...
// Static staging user, manually registered ONCE with this exact Mailinator
...
export const registeredUser = new InvitedUser(
  mailboxAddress(MailinatorInbox.INVITE_REGISTERED),
